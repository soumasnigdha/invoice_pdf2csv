prompt = """
    ...
    Expected fields:
    {
      "selling_website": "string",  # e.g., "Flipkart", "Amazon", etc.
      "seller_name": "string",
      "seller_gstin": "string",
      ...
      "items": [
        {
          ...
          "qty": "number",
          "gross_amount": "number",
          "discounts_coupons": "number",
          "taxable_value": "number",
          "sgst_utgst_amount": "number",
          "cgst_amount": "number",
          "igst_amount": "number",
...
if st.button("Process Invoices"):
    if not uploaded_files:
        ...
        with st.spinner("Processing invoices... Please wait, this may take a moment."):
            success = process_invoices(prompt, INPUT_DIR, OUTPUT_DIR, FINAL_CSV_PATH)
            if success:
